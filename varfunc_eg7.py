# -*- coding: utf-8 -*-
"""
Created on Wed Feb 27 16:53:12 2019
...
#    t1c[0,j] = t1q[0,j]**2 +3.5*t1q[0,j]
#    t1c[1,j] = 0.5*t1q[1,j]**2 +3.5*t1q[1,j]
t1c[0,0] = 1*t1q[0,0]**2 +3.5*t1q[0,0]
t1c[0,1] = 1*t1q[0,1]**2 +3.5*t1q[0,1]
t1c[0,2] = 0.5*t1q[0,2]**2 +5*t1q[0,2]
t1c[1,0] = 0.5*t1q[1,0]**2 +3.5*t1q[1,0]
t1c[1,1] = 0.5*t1q[1,1]**2 +3.5*t1q[1,1]
t1c[1,2] = 0.5*t1q[1,2]**2 +5*t1q[1,2]
############################################################
