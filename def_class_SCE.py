...
########################################################################
mlist = []
mlist.append(Make('m1',('r1','r2','r3'))) #add r3 to represent ecommerce
rlist = []
rlist.append(Retail('r1','b1'))
rlist.append(Retail('r2','b1'))
rlist.append(Retail('r3','b1')) #sell to the same market
blist = []
blist.append(Buy('b1'))
...
##############################################################
t1c[0,0] = (2*t1q[0,0] +t1q[0,1] +2)*t1q[0,0]
t1c[0,1] = (2*t1q[0,1] +t1q[0,0] +2)*t1q[0,1]
t1c[0,2] = 5 + t1q[0,2] + 2*t1q[0,2]**2  #tran and handling cost to m
...
###########################################################
t2c[0,0] = 2*t2q[0,0] + 1
t2c[1,0] = 2*t2q[1,0] + 10
t2c[2,0] = 0*t2q[2,0] + 0 #0, just for diff to work
########################################################### 
