# -*- coding: utf-8 -*-
"""
Created on Sun Mar 10 19:46:25 2019
...
########################################################################
mlist = []
mlist.append(Make('m1',('r1','r2','r3')))
mlist.append(Make('m2',('r1','r2','r3')))
rlist = []
rlist.append(Retail('r1',('b1','b2')))
rlist.append(Retail('r2',('b1','b2')))
rlist.append(Retail('r3',('b1','b2')))
blist = []
blist.append(Buy('b1'))
blist.append(Buy('b2'))
...
f[1] = (2.5*(np.sum([t1q[1,:]]))**2 + 12*(np.sum([t1q[1,:]])) 
+(np.sum([t1q[0,:]]))*(np.sum([t1q[1,:]])))
...
##############################################################
t1c[0,0] = (1*t1q[0,0] +3.5)*t1q[0,0]
t1c[0,1] = (1*t1q[0,1] +3.5)*t1q[0,1]
t1c[0,2] = (0.5*t1q[0,2] +5)*t1q[0,2]
t1c[1,0] = (0.5*t1q[1,0] +3.5)*t1q[1,0]
t1c[1,1] = (0.5*t1q[1,1] +3.5)*t1q[1,1]
t1c[1,2] = (0.5*t1q[1,2] +5)*t1q[1,2]
############################################################
############################################################
