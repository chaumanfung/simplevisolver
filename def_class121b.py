...
##############################################################
f[0] = 2*(np.sum([t1q[0,:]]))**2 + 2 +5*(np.sum([t1q[0,:]]))
f[1] = 2.5*(np.sum([t1q[1,:]]))**2 + 5*(np.sum([t1q[1,:]]))
##############################################################
##############################################################
## edit transaction cost faced by manufactuerers here
##############################################################
t1c[0,0] = (t1q[0,0] +2)*t1q[0,0]
t1c[0,1] = (t1q[0,1] +2)*t1q[0,1]
t1c[1,0] = (t1q[1,0] +2)*t1q[1,0]
t1c[1,1] = (t1q[1,1] +2)*t1q[1,1]
